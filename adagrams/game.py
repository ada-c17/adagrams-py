...
#this function does NOT take into account probability and draws letters from a list generated by the keys of copy_dict. This was our original function before homeroom adagrams review discussion 
def draw_letters():
    '''
    parameters: none

    This function draws 10 letters from our letter pool by:
    --initializes a letters_list
    --copies the provided LETTER_POOLS frequency dictionary
    --randomly removes a letter from the copy_dict and appends it to the letter_list 10 times
    --if the value of the copy_dict letter dips below 0, the letter key is removed from the copy_dict
